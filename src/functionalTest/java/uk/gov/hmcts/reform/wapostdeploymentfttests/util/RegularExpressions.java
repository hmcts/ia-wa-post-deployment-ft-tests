...
public final class RegularExpressions {
    ...
    public static final Pattern TODAY_PATTERN = Pattern.compile("\\{\\$TODAY([+-]?\\d*?)(?:-WORKING-DAYS)?}");
    public static final Pattern DATETIME_TODAY_PATTERN =
        Pattern.compile("\\{\\$DATETIME-TODAY([+-]?\\d*?)(?:-WORKING-DAYS)?}");
    ...
    public static final Pattern VERIFIER_DATETIME_WORKING_DAYS_TODAY_PATTERN =
        Pattern.compile("\\{\\$VERIFIER-DATETIME-TODAY([+-]?\\d*?)(?:-WORKING-DAYS)?}");
}
